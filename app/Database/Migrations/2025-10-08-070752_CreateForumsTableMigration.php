...
class CreateForumsTableMigration extends Migration
{
    public function up()
    {
        // Forum Categories
        ...
        $this->forge->createTable('forum_topics');
        ...
        $this->forge->addKey('id', true);
        $this->forge->addForeignKey('topic_id', 'forum_topics', 'id', 'CASCADE', 'CASCADE');
        $this->forge->addForeignKey('user_id', 'users', 'id', 'CASCADE', 'CASCADE');
    ...
    public function down()
    {
        ...
        $this->forge->dropTable('forum_topics');
