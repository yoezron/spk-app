                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="parent_id" name="parent_id">
                                        ...
                                        <?php foreach ($parentMenus as $parent): ?>
                                            <?php if ($parent->id != $menu->id): // Prevent circular reference 
                                            ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus menu <strong><?= esc($menu->title) ?></strong>?</p>
                <?php if (!empty($menu->children_count)): ?>
                    <p class="text-danger">
                        <i class="fas fa-exclamation-triangle"></i>
            ...
            <div class="modal-footer">
                ...
                <form action="<?= base_url('super/menus/' . $menu->id . '/delete') ?>" method="POST" style="display: inline;">
                    <?= csrf_field() ?>
